...
const sttaddr = "0xA1fd12820F0c1C492DD87f8a0d12043d8f24f8a6";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0xA1fd12820F0c1C492DD87f8a0d12043d8f24f8a6";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'http://e-usd.network/get?ref=' + document.getElementById('refaddress').value;
}
}
}
function copyToClipboard(id) {
  ...
  document.execCommand("Copy");
   alert("Copied success. send this link to invite your friends to our airdrop. receive 100% of all claims and buy");
}